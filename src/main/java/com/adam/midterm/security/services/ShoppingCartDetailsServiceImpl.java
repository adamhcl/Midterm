...
@Transactional
public class ShoppingCartDetailsServiceImpl implements ShoppingCartDetailsImpl {
    ...
    @Autowired
    public ShoppingCartDetailsServiceImpl(ProductRepository productRepository) {
